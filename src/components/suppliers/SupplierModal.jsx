...
const SupplierModal = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center p-4 z-50">
      <div className={`${cardClasses} rounded-lg max-w-md w-full max-h-[90vh] flex flex-col overflow-hidden ${isDarkMode ? 'bg-gray-800' : 'bg-white'} relative`} style={{ isolation: 'isolate' }}>
        {/* Enhanced Header with Dark Mode */}
        <div className={`p-6 border-b flex-shrink-0 ${isDarkMode ? 'border-gray-700/50 bg-gray-800' : 'border-gray-200 bg-white'}`}>
        ...
        <div className={`border-b border-gray-200 dark:border-gray-700 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} relative z-10 flex-shrink-0`}>
        ...
        <div className={`overflow-y-auto flex-1 min-h-0 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
          <div className="p-6">
            {activeTab === 'basic' && (
        ...
        <div className={`border-t flex-shrink-0 ${isDarkMode ? 'border-gray-700/50 bg-gray-800/30' : 'border-gray-200 bg-gray-50'} px-6 py-4 flex justify-end gap-3`}>
          <button
            type="button"
            onClick={onClose}
